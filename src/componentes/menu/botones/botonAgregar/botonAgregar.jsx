...
const BotonAgregar = ({ onAgregar,tipoComida}) => {
    return (
        <button
        id="btn-agregar-comida"
        className="btn btn-success d-flex flex-row justify-content-center align-items-center btn-generico parrafo"
        type="button"
        data-bs-toggle="modal"
        data-bs-target="#modalForm"
        onClick={onAgregar}
    >
        Agregar {capitalize(tipoComida)}
