            ...
            <div className="container py-4 py-xl-5">
                <div className="row gy-4 gy-md-0">
                    <div className="col-sm-12 col-md-7 col-lg-6 col-xl-6 col-xxl-6 d-md-flex align-items-md-center">
                        <div id="introHero">
                            <h2 data-aos="fade-down" data-aos-duration="750" id="titulo-hero" className="text-uppercase titulo">Hamburguesas únicas para <br />gente única</h2>
                            ...
                            <Link className="btn btn-lg fw-normal me-2 parrafo btn-generico btn-degradado btn-hero" role="button" to="/menu-hamburguesas"><strong>Explora el Menú</strong></Link>
